 ...
 */
final class Version20211018162723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE allocation_credit (id INT NOT NULL, credit_ouvert_id INT NOT NULL, association_allocation_actuel_id INT DEFAULT NULL, mairie_communale_id INT NOT NULL, autorisation_marche_id INT DEFAULT NULL, compte_nature_id INT NOT NULL, montant_allouer DOUBLE PRECISION NOT NULL, description_allocation VARCHAR(255) DEFAULT NULL, est_valide BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE autorisation_marche (id INT NOT NULL, mairie_communale_id INT NOT NULL, compte_nature_id INT NOT NULL, relation_modifier_id INT DEFAULT NULL, objet_autorisation TEXT NOT NULL, montant_autorisation DOUBLE PRECISION NOT NULL, explication_autorisation TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE credit_ouvert (id INT NOT NULL, ressource_financiere_id INT NOT NULL, association_credit_actuel_id INT DEFAULT NULL, compte_nature_id INT NOT NULL, montant_inscription DOUBLE PRECISION NOT NULL, description_inscription VARCHAR(255) DEFAULT NULL, est_valide BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE exercice_registre (id INT NOT NULL, nomenclature_id INT NOT NULL, annee_exercice INT NOT NULL, ordonateur_exercice VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, est_en_cours BOOLEAN NOT NULL, date_vote DATE DEFAULT NULL, date_adoption DATE DEFAULT NULL, date_cloture DATE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE nomenclature (id INT NOT NULL, annee_application VARCHAR(4) NOT NULL, decret_adoption VARCHAR(30) DEFAULT NULL, date_adoption DATE DEFAULT NULL, decret_application VARCHAR(30) DEFAULT NULL, date_application DATE DEFAULT NULL, description_nomenclature VARCHAR(255) DEFAULT NULL, est_actif BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ressource_financiere (id INT NOT NULL, exercice_registre_id INT NOT NULL, bailleur_fonds_id INT NOT NULL, association_ressource_actuel_id INT DEFAULT NULL, statut_registre_id INT NOT NULL, objet_financement VARCHAR(100) NOT NULL, mode_financement VARCHAR(100) NOT NULL, montant_financement DOUBLE PRECISION NOT NULL, description_financement VARCHAR(255) DEFAULT NULL, est_valide BOOLEAN NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lien_registre DROP CONSTRAINT FK_D10B6D8CF44461D3');
        ...
        $this->addSql('ALTER TABLE lien_registre DROP CONSTRAINT FK_D10B6D8C3256915B');
        ...
        $this->addSql('ALTER TABLE lien_registre DROP CONSTRAINT FK_D10B6D8C1DA245B3');
        ...
        $this->addSql('ALTER TABLE lien_registre DROP CONSTRAINT FK_D10B6D8C72D4DE99');
