 ...
 */
final class Version20211016070433 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte_nature (id INT NOT NULL, nomenclature_id INT NOT NULL, compte_nature_id INT DEFAULT NULL, numero_compte_nature INT NOT NULL, libelle_compte_nature VARCHAR(255) NOT NULL, section_compte_nature VARCHAR(30) DEFAULT NULL, hierachie_compte_nature VARCHAR(30) NOT NULL, description_compte_nature VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE exercice_registre (id INT NOT NULL, nomenclature_id INT NOT NULL, annee_exercice INT NOT NULL, ordonateur_exercice VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, est_en_cours BOOLEAN NOT NULL, PRIMARY KEY(id))');
