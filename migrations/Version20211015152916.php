 ...
 */
final class Version20211015152916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE nomenclature (id INT NOT NULL, annee_application INT NOT NULL, decret_adoption VARCHAR(30) DEFAULT NULL, date_adoption DATE DEFAULT NULL, decret_application VARCHAR(30) DEFAULT NULL, date_application DATE DEFAULT NULL, description_nomenclature VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
