...
const ConsultAlloue = ({ history }) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/api/ouverts/1/allocations")
    ...
    <div className="modal-dialog modal-lg" role="document">
      <div className="modal-content">
        ...
        <div className="modal-body">
                             ...
                             <p>{registr.actualiseAllocation}</p>
                                <h5>Description</h5>
                                  <p>{registr.descriptionAllocation}</p>
        </div>
                      ...
                      <table className="table table-bordered">
                        ...
                        <tbody>
                          {paginatedRegistres.map((registre) => (
                            <tr key={registre.id}>
                              <td>{registre.id}</td>
                              <td>{registre.montantAllouer}</td>
                              <td>{registre.autorisationMarche.montantAutorisation}</td>
                              <td>{registre.autorisationMarche.mairieCommunale.abbreviationMairie}</td>
                              <td>
                                <button
