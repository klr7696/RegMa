    ...
    <div className="modal-dialog modal-lg" role="document">
      <div className="modal-content">
        ...
        <div className="modal-body">
                             ...
                             <p>{registr.explicationAutorisation}</p>
                                <h5>Description</h5>
                                  <p>{registr.associationRegistre}</p>
                                  <h5>Status du Registre</h5>
                             <p>{registr.associationStatut}</p>
                                <h5>Description</h5>
                                  <p>{registr.associationBailleur.map(bailleur => ( <tr key={bailleur.id}>
                              <td>{bailleur.sigleBailleurs}</td>
                              </tr>
                              ))}</p>
        </div>
                      ...
                      <table className="table table-bordered">
                        ...
                        <tbody>
                          {paginatedRegistres.map((registre) => (
                            <tr key={registre.id}>
                              <td>{registre.id}</td>
                              <td>{registre.objetAutorisation}</td>
                              <td>{registre.montantAutorisation}</td>
                              <td>{registre.mairieCommunale}</td>
                              <td>{registre.compteNature}</td>
                              <td>
                                <button
...
export default ConsultAutorise;
