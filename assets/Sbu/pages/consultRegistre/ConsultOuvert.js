...
const ConsultOuvert = ({ history }) => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/api/ressources/1/ouverts")
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
                             ...
                             <p>{registr.statutRegistre.statut}</p>
                                <h5>Description</h5>
                                  <p>{registr.descriptionInscription}</p>
        </div>
                      ...
                      <table className="table table-bordered">
                        ...
                        <tbody>
                          {paginatedRegistres.map((registre) => (
                            <tr key={registre.id}>
                              <td>{registre.id}</td>
                              <td>{registre.compteNature.numeroCompteNature}</td>
                              <td>{registre.compteNature.libelleCompteNature}</td>
                              <td>{registre.montantInscription}</td>
                              <td>
                                <button
