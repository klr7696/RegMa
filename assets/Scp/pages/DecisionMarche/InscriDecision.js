    ...
    <section id="exp">
      ...
      <div className="row">
        ...
        <div className="row form-group">
                ...
                <div className="row form-group">
                <div className="col-sm-2">
                    <label className="col-form-label">Journal de publication</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
                  ...
                  <div className="col-sm-2">
                    <label className="col-form-label">Numero de publication</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
                ...
                <div className="row form-group">
                <div className="col-sm-2">
                    <label className="col-form-label">Date de publication</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
                  ...
                  <div className="col-sm-2">
                    <label className="col-form-label">Projet de marche</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
