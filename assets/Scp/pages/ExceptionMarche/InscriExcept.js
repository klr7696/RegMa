...
const InscriException = (props) => {
  ...
  <form onSubmit={handleSubmit}>
        <div className="row form-group">
                ...
                <div className="row form-group">
                <div className="col-sm-2">
                    <label className="col-form-label">delais d'execution</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
                  ...
                  <div className="col-sm-2">
                    <label className="col-form-label">planPassation</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
                ...
                <div className="row form-group">
                <div className="col-sm-2">
                    <label className="col-form-label">lienPlan</label>
                  </div>
                  <div className="col-sm-4">
                    <input
                      type="text"
...
export default InscriException;